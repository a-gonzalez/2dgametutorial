...
{// this class will handle all the game assets (door, boot, key, etc...)
    ...
    public void setItems()
    {
        ...
        game.items[0].world_x = 23 * game.TILE_SIZE;
        game.items[0].world_y = 7 * game.TILE_SIZE;

        game.items[1] = new Key(game);
        game.items[1].world_x = 23 * game.TILE_SIZE;
        ...
        game.items[4].world_x = 10 * game.TILE_SIZE;
        game.items[4].world_y = 7 * game.TILE_SIZE;
    }
